// 車の中で動作する車アプリを実装するための基本クラス
// サービス宣言 アプリは、車のホストによってバインドされるようCarAppServiceを拡張する必要があります。サービスは、SERVICE_INTERFACEアクションを処理する AndroidManifest.xmlのサービスへintent-filter を追加することにより、ホストからのIntentアクションにも応答する必要があります。アプリは、それがどのカテゴリのアプリケーションであるかを宣言する必要もあります（例えばCATEGORY_NAVIGATION_APPなど。）
/*
